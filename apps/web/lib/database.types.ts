  ...
  public: {
    Tables: {
      ...
      carriers: {
        ...
        Relationships: [
          {
            foreignKeyName: "carriers_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "carriers_factoring_company_id_fkey"
            columns: ["factoring_company_id"]
            isOneToOne: false
            referencedRelation: "factoring_companies"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      factoring_companies: {
        ...
        Relationships: [
          {
            foreignKeyName: "factoring_companies_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
